...
MAX_RECORDS=100_000;MAX_DOCUMENT_BYTES=1024*1024
...
def capture_snapshot():
 with db.transaction() as tx:
  ...
  rows=tx.query("SELECT id,sql_text,database_name,executed_at,execution_time,row_count,status,error_message,user_email,trigger_source,dataset_id,tables_used FROM query_history ORDER BY id LIMIT @param0",[MAX_RECORDS+1])["rows"]
