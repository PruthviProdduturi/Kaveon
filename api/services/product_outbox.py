...
SUPPORTED_FAMILIES = {
    "datasets", "charts", "dashboards", "saved_queries", "user_themes", "user_recents", "favorites", "catalog_sources", "data_sources", "activity", "chat_sessions", "chat_messages", "dlm_definitions", "query_history",
}
