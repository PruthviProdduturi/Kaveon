...
immutable ADLS objects, alternates exclusive Kaveon/Trino leases on the existing
nodes, and evaluates the resulting report with `trino_cloud_claim_gate.py`.
