...
> See `docs/patent-adaptive-context-routing.md` for the full claim set, `docs/whitepaper-dlm.md` for the DLM deep dive, and `docs/whitepaper-dlm-curation.md` for curation at scale.
