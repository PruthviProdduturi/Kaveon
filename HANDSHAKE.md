...
| `cli` — `kaveon` interactive SQL shell | **Claude** (from 2026-09-17, architect's direction) | Remote-first client 0.2.0 done (Codex). Overhaul to 0.3.0 in progress per `docs/superpowers/specs/2026-09-17-cli-overhaul-design.md`: inline rich shell, live progress, cancel, paged results, `EXPLAIN`, session settings. Codex's build gates unchanged |
