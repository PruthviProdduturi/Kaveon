...
|---|---|---|---|
| Manifest atomicity | Commit table and control-record changes together; inject an invalid control change | One generation contains all valid changes; any invalid member publishes nothing and leaves head unchanged | Integrated local tests pass at `8157205`; live ADLS fault evidence remains required |
