...
| 2026-09-02 | Codex | Hardened the localhost stack after clean-runner startup testing: Studio health now probes the public docs route over IPv4, and the local API uses one worker to serialize its legacy runtime schema bootstrap. |
