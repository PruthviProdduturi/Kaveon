...
import { WeftLoading } from "../components/WeftLoading";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // All Weft metadata (dashboards, charts, datasets, favorites, queries)
    ...
    const labCacheKey = `weft_lab_tables_v1_${userEmail || 'anon'}`;
      ...
      if (labCacheFavDb && typeof window !== 'undefined') {
        try {
          localStorage.setItem(
            `weft_lab_tables_v1_${userEmail || 'anon'}`,
