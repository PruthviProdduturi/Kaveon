          ...
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "inline-flex", borderRadius: 999, border: "1px solid var(--weft-border)", padding: 2, marginTop: 4 }}>
                  <button
                    type="button"
                    ...
                    style={{
                      ...
                      color: mode === "flat" ? "#ffffff" : "var(--weft-text)",
                      borderRadius: 999,
                      padding: "4px 10px",
                      fontSize: 13,
                      cursor: "pointer",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: mode === "semantic" ? "#ffffff" : "var(--weft-text)",
                      borderRadius: 999,
                      padding: "4px 10px",
                      fontSize: 13,
                      cursor: "pointer",
