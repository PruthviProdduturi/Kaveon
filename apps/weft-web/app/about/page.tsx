    ...
    <div style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif", color: "#0f172a" }}>
        ...
        <div style={{ position: "relative", maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/" style={{
              ...
              <i className="fas fa-arrow-right" style={{ marginRight: 8 }} />Open Weft
            </Link>
      ...
      <Section id="features" bg="#f8fafc">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 20 }}>
          ...
          <FeatureCard icon="fa-layer-group" color="#0ea5e9"
            ...
            body="Define dimensions, metrics, and filter columns once. Weft auto-generates optimised SQL with multi-table JOINs. Change the dataset — every chart and dashboard updates automatically." />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 15.5, color: "#475569", lineHeight: 1.75 }}>
              The Weft dashboard builder gives you a pixel-precise drag-and-drop canvas. Combine charts,
      ...
      <Section id="datasources" bg="white">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <SectionSub center>
            ...
            Weft creates a dedicated connection pool for each source at registration time.
          </SectionSub>
        </div>
      ...
      <Section id="ai" bg="white">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 15.5, color: "#475569", lineHeight: 1.75, marginBottom: 28 }}>
              The Weft AI Assistant understands your data context — pass the active SQL, the data source,
          ...
          {[
            {
              ...
              body: "Open Weft in your browser and click Sign In. Authenticate with your Microsoft work account — no separate username or password needed. Your Azure AD App Role determines your access level automatically.",
          ...
          <div style={{ marginTop: 40, background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 14, padding: "24px 28px", display: "flex", gap: 20, alignItems: "flex-start" }}>
            ...
            <div>
              ...
              <ul style={{ margin: 0, padding: "0 0 0 16px", fontSize: 13.5, color: "#166534", lineHeight: 2 }}>
                ...
                <li>Azure AD → Enterprise Applications → Weft → Users and groups — assign Azure AD App Roles (Viewer / Analyst / Editor / Admin) to team members</li>
              </ul>
            </div>
          </div>
        )}
      ...
      <Section id="whatsnew" bg="#f8fafc">
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <SectionSub center>Weft ships improvements continuously. Here are the most recent highlights.</SectionSub>
        </div>
          ...
          {[
            {
              ...
              a: "Yes — Weft uses Azure AD for authentication. Your organisation needs an Azure AD tenant and an App Registration with the four App Roles defined. The data sources themselves can be on any supported engine.",
            },
            {
            ...
            },
            {
              ...
              a: "Assign the appropriate Azure AD App Role (Viewer / Analyst / Editor / Admin) to the user in Azure portal → Enterprise Applications → Weft → Users and groups. They can sign in immediately.",
            },
            {
              q: "What happens if the metadata DB goes down?",
              a: "The Weft API will return 503 for endpoints that require metadata. The UI shows a connection error. Existing browser sessions are preserved — as soon as the DB recovers, the API reconnects automatically.",
            },
            {
              q: "Can I connect multiple data sources of the same type?",
              a: "Yes. Each data source registration is independent with its own connection pool. You can have multiple Fabric SQL databases, multiple PostgreSQL instances, and so on — all available from a single Weft instance.",
            },
            {
              q: "How are queries executed? Does Weft cache results?",
            ...
            },
            {
              ...
              a: "Each data source uses its native dialect — T-SQL for Fabric / Azure SQL, standard SQL for PostgreSQL and MySQL, Trino SQL for Trino, and StarRocks SQL for StarRocks. Weft passes queries through without rewriting.",
            },
            {
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, color: "#475569" }}>
          <strong style={{ color: "#94a3b8" }}>Weft</strong> — the analyze layer of the Kaveon data platform. See the pattern.
