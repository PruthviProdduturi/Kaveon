...
import { WeftLoading } from "./WeftLoading";
...
interface ListPageShellProps {
  ...
  action?: ReactNode;
  /** Loading state — shows WeftLoading spinner */
  loading?: boolean;
...
export function ListPageShell({
  ...
  return (
    <div className="page-shell animate-fade-in">
      ...
      {/* ── Loading ── */}
      {loading && <WeftLoading message={loadingMessage} />}

      {/* ── Error ── */}
      {!loading && error && (() => {
        const metadataReady = typeof sessionStorage !== "undefined"
          ? sessionStorage.getItem("weft_setup_ok") === "1"
          : true;
        if (!metadataReady) {
          return (
            <div className="card page-empty-card">
              ...
              <p className="page-empty-body">
                Weft needs a metadata database to store dashboards, charts, and datasets.{" "}
