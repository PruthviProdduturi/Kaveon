    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 4 }}>
          <WeftLogo size={48} animate="pulse" />
        </div>
        ...
        <p style={{ fontSize: 13.5, color: "#94a3b8", lineHeight: 1.65, marginBottom: 28 }}>
          Weft needs a metadata database to store your data. Configure it in System Settings to get started.
        </p>
        <a
...
const SETUP_OK_KEY = "weft_setup_ok";
    ...
    <div style={{ position: "fixed", inset: 0, background: "#f8fafc", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ textAlign: "center", maxWidth: 400 }}>
        ...
        <p style={{ fontSize: 14, color: "#64748b", lineHeight: 1.6, margin: "0 0 28px" }}>
          You don&apos;t have a role assigned in Weft. Contact your administrator and ask them to assign you a role via Azure AD → Enterprise Applications → Weft → Users and groups.
        </p>
        <button
          onClick={onLogout}
