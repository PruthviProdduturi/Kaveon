      ...
      {!inConversation && (
        ...
        >
          <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem", width: "100%", maxWidth: 680, padding: "0 1.5rem" }}>
            ...
            <h1 style={{ margin: "0 0 8px", fontSize: 32, fontWeight: 500, color: "#f0f0f2", textAlign: "center", letterSpacing: "-0.5px", display: "flex", alignItems: "center", justifyContent: "center", gap: 12 }}>
