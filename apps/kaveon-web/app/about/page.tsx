  ...
  return (
    <div style={{ background: "#0a0a0a", color: "#f5f5f5", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <a href="/about" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "#f5f5f5" }}>
          <KaveonMark size={22} useDirectColor />
          <span style={{ fontSize: 15, fontWeight: 600, letterSpacing: "2px" }}>KAVEON</span>
        </a>
