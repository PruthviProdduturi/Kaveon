        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  var savedColor = localStorage.getItem('loomx-theme-color');
                  if (savedColor) {
                    // Generate gradients
                    ...
                    document.documentElement.style.setProperty('--loomx-primary', savedColor);
                    document.documentElement.style.setProperty('--loomx-secondary', light);
