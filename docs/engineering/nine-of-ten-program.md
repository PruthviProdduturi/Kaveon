...
| Docs | 7 | No duplicated topic; the connectors, settings and runbook pages are validated by CI against code. | the four consolidations from the 09-17 audit → CI checks for settings/connectors tables against `config.rs` and the catalog formats |
