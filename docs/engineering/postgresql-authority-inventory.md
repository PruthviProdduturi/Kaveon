...
| `query_history` | `services/query_history.py`, DLM usage | Typed owner-isolated `query_history`, optional dataset reference | Bounded deterministic backfill, default-off atomic append/delete events and owner-list shadow exist; retention policy, live evidence and cutover remain |
